      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="game-card mb-8">
          <h2 className="text-xl font-bold text-white mb-6 flex items-center">
            <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center mr-3">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-8 gap-3">
            {[3, 4, 5, 6, 7, 8, 9, 10].map((size) => {
              const stars = size <= 6 ? 3 : size <= 8 ? 2 : 0
              return (
                <div key={size} className="text-center">
                  <div className={`aspect-square rounded-xl flex flex-col items-center justify-center mb-2 ${
                    ...
                    <span className="text-lg font-bold text-white">{size}×{size}</span>
